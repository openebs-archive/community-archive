...
variable "clustername" { default = "oebs-dev" }

# Default: 3 (Accomodate min. 3 OpenEBS vol replicas as per recommendation)
variable "nodecount" { default = "2" } 

# Default: Latest stable GKE version (1.8.7-gke) 
variable "master_version" { default = "1.7.12-gke.1" }
variable "node_version" { default = "1.7.12-gke.1" } 
